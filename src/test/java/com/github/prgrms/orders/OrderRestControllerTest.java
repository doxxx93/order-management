...
class OrderRestControllerTest {
    ...
    private static final Map<Integer, Integer> productIdForOrderId = new HashMap<>() {{
        put(1, 1);
        put(2, 1);
        put(3, 2);
        put(4, 2);
    ...
    private static final Map<Integer, String> stateForOrderId = new HashMap<>() {{
        put(1, "REQUESTED");
        put(2, "ACCEPTED");
        put(3, "SHIPPING");
        put(4, "COMPLETED");
    ...
    private static final Map<Integer, String> requestMessageForOrderId = new HashMap<>() {{
